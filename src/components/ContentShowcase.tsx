      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4">
            Our Creative <span className="text-green-400">Universe</span>
          </h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Discover our latest musical and visual creations generated by artificial intelligence
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3 mb-8">
              ...
              <h3 className="text-2xl font-bold text-white">AI Music</h3>
            </div>
          ...
          <div className="space-y-6" id="videos">
            <div className="flex items-center space-x-3 mb-8">
              ...
              <h3 className="text-2xl font-bold text-white">AI Videos</h3>
            </div>
